...
const routes: Routes = [
  ...
  children:[
      ...
      {path:'contractrenewal',loadChildren:()=>import('./contracts/contractrenewal/contractrenewal.module').then(m=>m.ContractrenewalModule)},
      {path:'querycontract',loadChildren:()=>import('./contracts/contractdetails/contractdetails.module').then(m=>m.ContractdetailsModule)},
      {path:'terminationcontract',loadChildren:()=>import('./contracts/terminationcontract/terminationcontract.module').then(m=>m.TerminationcontractModule)},
