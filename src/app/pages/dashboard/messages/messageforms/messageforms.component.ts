...
onSubmit(){
  if(this.messageForm.valid){
   if(this.btnAddandUpdate == 'add'){
    ...
    this._messageFormsServices.createMessage(data).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
      // console.log(res);
    ...
    this._messageFormsServices.updateData(data).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
getAllDataMessageForms(){
  ...
  this._messageFormsServices.getAllDataMessageForms(this.pageIndex,this.pageSize).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
getUpdateData(id:any){
  ...
  this._messageFormsServices.getDataUpdate(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
deleteConfirmed(id:any){
  ...
  this._messageFormsServices.deleteData(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
