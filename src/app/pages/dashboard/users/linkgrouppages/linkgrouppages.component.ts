...
_linkGrouppagesServices:LinkgrouppagesService=inject(LinkgrouppagesService)
...
if(this.groupForm.valid){
  ...
  if(this.btnaddAndUpdate == 'add'){
    ...
    this._linkGrouppagesServices.addPageAndGroup(this.groupForm.value).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
    ...
    this._linkGrouppagesServices.updatePageAndGroup(this.groupForm.value).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
getDataUpdate(id:any){
  ...
  this._linkGrouppagesServices.getDataById(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{7
    console.log(res);
...
getAllGroups(){
  ...
  this._sharedServices.getAllGroups().pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
    console.log(res);
...
getAllPages(){
  this._sharedServices.getAllPages(0,0).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
    ...
    console.log(this.getAllDataPages)
    })
}
...
getAllData(){
  this._linkGrouppagesServices.getAllDatagroupPages(this.pageIndex,this.pageSize).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
deleteConfirmed(id:any){
 ...
 this._linkGrouppagesServices.deleteData(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
