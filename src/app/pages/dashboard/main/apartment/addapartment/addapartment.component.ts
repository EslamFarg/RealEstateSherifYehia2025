...
export class AddapartmentComponent {
  ...
  _classificationServices:ClassificationapartmentService=inject(ClassificationapartmentService)
  ...
  ngOnInit(): void {
    ...
    this._behaviorServices.idSubscribe.pipe(takeUntilDestroyed(this.destroyRef)).subscribe((id)=>{
      if(id){
        ...
        this._apartmentServices.getDataUpdate(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
  ...
  onSubmit(){
    console.log(this.unitData.value);
  ...
  if(this.btnaddandupdate == 'add'){
    let formData=new FormData();
      ...
      formData.append('UnitCategoryId',this.unitData.value.UnitCategoryId || '');
      ...
      this._apartmentServices.createApartment(formData).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
        this.unitData.reset();
    ...
    formData.append('FloorNumber',this.unitData.value.FloorNumber || '');
    formData.append('Price',this.unitData.value.Price || '');
    formData.append('Description',this.unitData.value.Description || 'hello marcos');
    formData.append('PropertyID',this.unitData.value.PropertyID || '');
    formData.append('UnitCategoryId',this.unitData.value.UnitCategoryId || '');
    ...
    this._apartmentServices.updateData(formData).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
searchData(value:any){
  ...
  this._apartmentServices.searchDataUnitNumber(data).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
deleteData(){
  if(this.unitNumber.nativeElement.value!='0' || this.unitNumber.nativeElement.value != null || this.unitNumber.nativeElement.value != undefined || this.unitNumber.nativeElement.value != ''){
...
deleteConfirmed(e:any){
  ...
  this.showDelete=false;
  this._apartmentServices.deleteData(e).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
unitCategoryData(){
  ...
  //   }
  // }
  this._classificationServices.getAllDataUnitCategories1({}).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
getAllDataProperty(){
  this._propertyServices.getAllDataBuilding({}).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
    console.log(res);
