...
export class BuildingComponent {
  ...
  getAllNameOwner(){
    this._ownerServices.getAllDataOwner({}).pipe(takeUntilDestroyed(this.$destroyRef)).subscribe((res:any)=>{
  ...
  onSubmit(){
    ...
    formData.append('PropertyNumber',this.formProperty.value.PropertyNumber || '');
    ...
    formData.append('BuildingNumber',this.formProperty.value.BuildingNumber || '');
    formData.append('PostalCode',this.formProperty.value.PostalCode || '');
    formData.append('Description',this.formProperty.value.Description || '');
    ...
    let files: File[] = this.formProperty.value.Files || [];
      ...
      //  console.log(res);
        ...
        data.append('PropertyNumber',this.formProperty.value.PropertyNumber || '');
        ...
        data.append('BuildingNumber',this.formProperty.value.BuildingNumber || '');
        ...
        this._BuildingServices.updateData(data).pipe(takeUntilDestroyed(this.$destroyRef)).subscribe((res:any)=>{
          this.resetForm();
  ...
  getAllDataProperties(){
    ...
    this._BuildingServices.getAllDataBuilding(pagination).pipe(takeUntilDestroyed(this.$destroyRef)).subscribe((res:any)=>{
