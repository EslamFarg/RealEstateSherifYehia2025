...
onSubmit(){
  if(this.maintenanceData.valid){
   if(this.btnAddandUpdate == 'add'){
    ...
    this._maintenanceService.createMaintenance(data).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
    ...
    this._maintenanceService.updateData(data).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
getAllDatamaintenance(){
  ...
  this._maintenanceService.getAllDataMaintenance(pagination).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
getDataUpdate(id:any){
  this._maintenanceService.getDataUpdate(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
deleteConfirmed(id:any){
  this.showDelete=false;
  this._maintenanceService.deleteData(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
