...
_EditBehaviorSer:EditBehaviorServiceService=inject(EditBehaviorServiceService)
...
getAllDataMaintenances(){
  ...
  this._maintenanceServices.getAllDataMaintenaces(pagination).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
    // console.log(res);
...
// }
  ...
  switch (e.index) {
    case 0: ShapeDataFilter.searchFilter.column = 0; break; 
    case 1: ShapeDataFilter.searchFilter.column = 4; break; 
    case 2: ShapeDataFilter.searchFilter.column = 2; break; 
    default: ShapeDataFilter.searchFilter.column = 8; break; 
  }
  ...
  this._maintenanceServices.searchData(ShapeDataFilter).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
...
deleteConfirmed(id:any){
  this.showDelete=false;
  this._maintenanceServices.deleteData(id).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((res:any)=>{
    this.getAllDataMaintenances();
  })
}
