...
export class AddmaintenanceComponent {
  ...
  onSubmit() {
    ...
    if (this.btnAddandUpdate == 'add') {
      ...
      formData.append(
        'BookNumber',
        this.mainTenanceData.value.BookNumber || ''
      );
      formData.append(
        'RequestDate',
        this.mainTenanceData.value.RequestDate || ''
      );
      formData.append(
        'TargetType',
        this.mainTenanceData.value.TargetType || ''
      );
      formData.append('TargetId', this.mainTenanceData.value.TargetId || '');
      formData.append(
        'MaintenanceTypeId',
        this.mainTenanceData.value.MaintenanceTypeId || ''
      );
      formData.append(
        'EmployeeId',
        this.mainTenanceData.value.EmployeeId || ''
      );
      ...
      formData.append(
        'TargetType',
        this.mainTenanceData.value.TargetType || '0'
      );
      formData.append('TargetId', this.mainTenanceData.value.TargetId || '');
      formData.append(
        'MaintenanceTypeId',
